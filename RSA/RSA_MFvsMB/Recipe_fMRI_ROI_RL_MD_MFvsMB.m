...
% conditionLabels = { ...
%     'outcome_RNxRN_RPE_MB0^1', ...
%     };

% conditionLabels = { ...
%      'outcome_RNxRN_PSw_MB1^1', ...
%     };

conditionLabels = { ...
     'outcome_RNxRN_RPE_MB0^1', ...
     'outcome_RNxRN_PSw_MB0^1', ...
...
%userOptions.rootPath = '/Users/binwang/Documents/Bochum/DATA/fMRI_RL_GoNoGo/Results_MD/Results_RSA/MD_MFvsMB/Data_RN_RPE';
%userOptions.rootPath = '/Users/binwang/Documents/Bochum/DATA/fMRI_RL_GoNoGo/Results_MD/Results_RSA/MD_MFvsMB/Data_RN_PSw';
userOptions.rootPath = '/Users/binwang/Documents/Bochum/DATA/fMRI_RL_GoNoGo/Results_MD/Results_RSA/MD_MFvsMB/RDMs_RN_MD_MFvsMB';
