...
% conditionLabels = { ...
%     'outcome_RN1xRN1_RPE_MB0^1', ...
%     'outcome_RN1xRN2_RPE_MB0^1', ...
%     };

% conditionLabels = { ...
%      'outcome_RN1xRN1_PSw_MB1^1', ...
%      'outcome_RN2xRN2_PSw_MB1^1'
%     };
...
userOptions = defineUserOptions_RL_MD_MFvsMB();
compareRDM=1;
%%

close all
userOptions.conditionLabels=conditionLabels;
%userOptions.rootPath = '/Users/binwang/Documents/Bochum/DATA/fMRI_RL_GoNoGo/Results_MD/Results_RSA/MD_MFvsMB/Cross_validation/Data_RN_RPE';
%userOptions.rootPath = '/Users/binwang/Documents/Bochum/DATA/fMRI_RL_GoNoGo/Results_MD/Results_RSA/MD_MFvsMB/Cross_validation/Data_RN_PSw';
userOptions.rootPath = '/Users/binwang/Documents/Bochum/DATA/fMRI_RL_GoNoGo/Results_MD/Results_RSA/MD_MFvsMB/Cross_validation/RDMs_RN_MD_MFvsMB';
...
responsePatterns_random=responsePatterns
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
